...
dvj.radialAxes = function() {
    ...
    function f() {
        dvj.drawRadialAxes(context, aScale, rScale, angularData, numTicks, useGrid, backdropOpacity);
    }
...
dvj.drawRadialAxes = function(svg, aScale, rScale,
    ...
    g.selectAll("text.angle.label")
       .data(angularData)
         .join("text")
            ...
            .text(d => d)
            .attr("x", (d,i) => dvj.p2c(aScale(i), rScale.range()[1] + 15)[0])
            .attr("y", (d,i) => dvj.p2c(aScale(i), rScale.range()[1] + 15)[1])
            .attr("transform", "rotate(90)");
}
