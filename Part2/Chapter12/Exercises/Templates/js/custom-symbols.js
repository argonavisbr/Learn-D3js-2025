...
// Use this module to create your own custom symbols that can be implemented in SVG (using d3.path())
// or in Canvas. The draw function should return a string if the context is an SVG path, or null if the
// context is a Canvas context. The size parameter is optional and defaults to 64.
// The size parameter is used to scale the symbol to the desired size.
// Use the existing implementations as examples.
