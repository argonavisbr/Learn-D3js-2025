...
/**
 * Select the planet. Scale the diameter, position it's center offscreen to the left and fill with current color.
 * @param plane The orbital plane (vertical center of the chart)
 */
function drawPlanet(plane) {
    plane.select(".planet")     // the planet was appended to the plane in init()
